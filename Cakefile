...
INCLUDES = ['Public/images', 'Public/lib']
LIBRARIES = ['Public/lib/jqconsole-2.10.0.min.js', 'Public/lib/bootstrap-tooltip.js', 'Public/lib/page.js']
CSS = ['style.css', 'print.css', 'ansi.css']
APP_FILES = ['Public/src/base.coffee', 'Public/src/browser-check.coffee', 'Public/src/dom.coffee',
             'Public/src/repl.coffee', 'Public/src/pager.coffee', 'Public/src/router.coffee', 'Public/src/session.coffee',
             'Public/src/languages.coffee']
...
task 'watch', 'Watch all coffee files and compile them live to javascript', ->
  ...
  jsreplWatch = spawn 'cake', ['watch'], cwd: './Public/jsrepl'
  ...
  # Our examples.
  for lang in fs.readdirSync 'Public/langs'
    for examples_file in fs.readdirSync 'Public/langs/' + lang
      if examples_file.match /\.txt$/
        file = "Public/langs/#{lang}/#{examples_file}"
